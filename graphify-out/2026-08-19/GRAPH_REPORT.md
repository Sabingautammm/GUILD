...
## Corpus Check
- 159 files · ~379,444 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1120 nodes · 1985 edges · 155 communities (140 shown, 15 thin omitted)
...
- `selectGame()` --calls--> `apiFetch()`  [EXTRACTED]
  FrontEnd/src/features/auth/services/authApi.js → FrontEnd/src/services/api/client.js
- `submitGameIdentity()` --calls--> `apiFetch()`  [EXTRACTED]
  FrontEnd/src/features/auth/services/authApi.js → FrontEnd/src/services/api/client.js
- `verifyLeaderPassword()` --calls--> `apiFetch()`  [EXTRACTED]
  FrontEnd/src/features/auth/services/authApi.js → FrontEnd/src/services/api/client.js
...
Cohesion: 0.14
Nodes (21): getMembers(), checkGuildUid(), completeOnboarding(), createGuild(), getCurrentUser(), googleLogin(), leaderLogin(), logout() (+13 more)
...
### Community 3 - "Skeleton.jsx"
Cohesion: 0.11
Nodes (16): LeaderboardPage, MembersPage, FullPageSkeleton(), Skeleton(), SkeletonCard(), SkeletonLeaderboard(), SkeletonList(), SkeletonProfile() (+8 more)

### Community 4 - "dependencies"
Cohesion: 0.12
Nodes (17): @capacitor/core, framer-motion, dependencies, @capacitor/core, framer-motion, react, react-dom, react-icons (+9 more)
...
Cohesion: 0.20
Nodes (18): GalleryPage, MediaCard(), GalleryPage(), IMAGE_EXTENSIONS, IMAGE_MIMES, validateMediaFile(), VIDEO_EXTENSIONS, VIDEO_MIMES (+10 more)
...
Cohesion: 0.23
Nodes (13): NotificationsPage, BottomNavbar(), navItems, DesktopNavbar(), navItems, useUnreadCount(), MobileHeader(), useAuth() (+5 more)
...
Cohesion: 0.14
Nodes (14): ProfilePage, PasswordInput(), usePlayerProfile(), getMyProfile(), updateMyProfile(), sanitizeStats(), usePlayerStatsSocket(), AVATAR_EXTENSIONS (+6 more)
...
### Community 21 - "resolveMediaUrl"
Cohesion: 0.18
Nodes (8): ModeStatsCard(), PlayerIdCard(), RankingCard(), SeasonStatsSection(), ROLE_LABEL, MediaPreviewCard(), API_ORIGIN, resolveMediaUrl()
...
Cohesion: 0.16
Nodes (16): isMobileDevice(), loadGsiScript(), SocialLogin(), AuthContext, AuthProvider(), changePassword(), checkGuildUid(), createGuild() (+8 more)
...
Cohesion: 0.19
Nodes (11): ToastDemoPage, ToastContext, ToastProvider(), useToast(), SkeletonMediaGrid(), MediaTab(), useLogin(), ToastDemoPage() (+3 more)
...
Cohesion: 0.17
Nodes (23): AdminPage, ActivityTab(), truncate(), MembersTab(), PendingTab(), TYPE_LABEL, TransferTab(), AdminPage() (+15 more)
...
Cohesion: 0.10
Nodes (9): App(), AppRoutes(), ErrorBoundary, MemberDetailsPage, ReelPage, Navbar(), ProtectedRoutes(), LoginForm() (+1 more)
...
Cohesion: 0.40
Nodes (9): GuildPage, SkeletonGuild(), GuildPage(), applyToGuild(), disbandGuild(), getGuildProfile(), getPrivateGuildView(), leaveGuild() (+1 more)

### Community 151 - "GuildPlayersTab.jsx"
Cohesion: 0.36
Nodes (6): GAMES, GuildPlayersTab(), STATUS_FILTERS, addPlayerByGameUid(), getGuildPlayers(), searchGuildPlayer()

### Community 152 - "react"
Cohesion: 0.53
Nodes (4): Avatar(), getMemberById(), MemberDetailsPage(), react
...
- **Why does `apiFetch()` connect `apiFetch` to `Skeleton.jsx`, `useToast`, `GalleryPage.jsx`, `EnterUidRegionPage.jsx`, `GuildPage.jsx`, `useAuth`, `ProfilePage.jsx`, `GuildPlayersTab.jsx`, `react`, `FFLiveData.jsx`, `adminApi.js`, `AuthContext.jsx`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `App.jsx`, `useToast`, `Skeleton.jsx`, `GalleryPage.jsx`, `EnterUidRegionPage.jsx`, `useAuth`, `GuildPage.jsx`, `ProfilePage.jsx`, `resolveMediaUrl`, `GuildPlayersTab.jsx`, `adminApi.js`, `FFLiveData.jsx`, `Toast.jsx`, `AuthContext.jsx`, `plugins`?**
